...
<body>
 ...
 <!-- ======================= Cards ================== -->
            ...
            <div class="details">
                <div class="recentOrders">
                    <div class="cardHeader">
                        ...
                        <button class="create-client-btn">Crear Cliente</button>
                        </div>
                        <!-- Campo de búsqueda -->
    ...
    <!-- Popup Crear Cliente -->
<div id="createClientPopup" class="popup">
  <div class="popup-content">
    ...
    <form id="createClientForm">
      ...
      <button type="button" id="submitCreateClient">Crear Cliente</button>
    </form>
  </div>
</div>

    <!--<input type="hidden" id="admin_id" name="admin_id"--> <!-- Campo oculto para admin_id -->
