...
<body>
 ...
 <!-- ======================= Cards ================== -->
                ...
                <div class="recentOrders">
                    <div class="cardHeader">
                        ...
                        <div class="button-container">
                            <button class="create-Maquina-btn">Crear Máquina</button>
                        </div>
                        <input type="text" id="searchInputmaquina" placeholder="Buscar Máquina...">
                    </div>
    ...
    <!-- Formularios emergentes para crear máquina -->

    <!-- Pop up A -->
    <div id="createMaquinaPopupA" class="popup">
        <div class="popup-content">
            <h2>Datos Técnicos</h2>
            <form id="createMaquinaFormA">
    ...
    <!-- Opciones se llenarán dinámicamente desde JavaScript -->
                ...
                <input type="text" id="serial_carroceria" name="serial_carroceria" required>
                ...
                <input type="text" id="serial_motor" name="serial_motor" required>
                <label for="color">Color:</label>
                <input type="text" id="color" name="color" required>
                <button type="button" onclick="showNextPopup('createMaquinaPopupA', 'createMaquinaPopupB')">Siguiente</button>
            </form>
        </div>
    </div>

    <!-- Pop up B -->
    <div id="createMaquinaPopupB" class="popup">
        <div class="popup-content">
            <h2>Caracteristicas Técnicas</h2>
            <form id="createMaquinaFormB">
                <label for="peso_operaciones">Peso Operaciones:</label>
                <input type="text" id="peso_operaciones" name="peso_operaciones" required>
                <label for="neumaticos">Neumáticos:</label>
                <input type="text" id="neumaticos" name="neumaticos" required>
                <label for="modelo_motor">Modelo del Motor:</label>
                <input type="text" id="modelo_motor" name="modelo_motor" required>
                <label for="transmision">Transmisión:</label>
                <input type="text" id="transmision" name="transmision" required>
                <label for="revoluciones_motor">Revoluciones del Motor:</label>
                <input type="text" id="revoluciones_motor" name="revoluciones_motor" required>
                <label for="combustible">Combustible:</label>
                <input type="text" id="combustible" name="combustible" required>
                <label for="potencia_neta">Potencia Neta:</label>
                <input type="text" id="potencia_neta" name="potencia_neta" required>
                <label for="peso_bruto_trabajo">Peso Bruto de Trabajo:</label>
                <input type="text" id="peso_bruto_trabajo" name="peso_bruto_trabajo" required>
                <label for="torque_neto">Torque Neto:</label>
                <input type="text" id="torque_neto" name="torque_neto" required>
                <label for="voltaje">Voltaje:</label>
                <input type="text" id="voltaje" name="voltaje" required>
                <label for="sistema_alimentacion">Sistema de Alimentación:</label>
                <input type="text" id="sistema_alimentacion" name="sistema_alimentacion" required>
                <label for="cilindros">Cilindros:</label>
                <input type="text" id="cilindros" name="cilindros" required>
                <button type="button" onclick="showNextPopup('createMaquinaPopupB', 'createMaquinaPopupC')">Siguiente</button>
            </form>
        </div>
    </div>

    <!-- Pop up C -->
    <div id="createMaquinaPopupC" class="popup">
        <div class="popup-content">
            <h2>Remplazo de Elementos</h2>
            <form id="createMaquinaFormC">
                ...
                <button type="button" onclick="showNextPopup('createMaquinaPopupC', 'createMaquinaPopupD')">Siguiente</button>
            </form>
        </div>
    </div>

    <!-- Pop up D -->
    <div id="createMaquinaPopupD" class="popup">
        <div class="popup-content">
            <h2>Historial del Equipo</h2>
            <form id="createMaquinaFormD">
                <label for="fecha_fabricacion">Fecha de Fabricación:</label>
                <input type="text" id="fecha_fabricacion" name="fecha_fabricacion" required>
                <label for="fecha_en_obra">Fecha en Obra:</label>
                <input type="text" id="fecha_en_obra" name="fecha_en_obra" required>
                <label for="tiempo_funcionamiento">Tiempo de Funcionamiento:</label>
                <input type="text" id="tiempo_funcionamiento" name="tiempo_funcionamiento" required>
