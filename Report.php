   ...
   <div class="container">
    <div class="navigation">
        <ul>
            ...
            <li>
                <a href="inicio.html" id="alertLink" data-page="index">
                    <span class="icon">
     ...
     <a href="Machine.php">
       <div class="card">
         ...
         <div class="iconBx">
            ...
            <!-- ================ Report Filter and Table ================= -->
            <section class="details">
                <div class="recentOrders">
                    <div class="cardHeader">
                        <h2>Reportes</h2>
                        <div class="button-container">
                            <button id="exportarBtn" class="create-Maquina-btn">Exportar</button>
                        </div>
                        ...
                        <input type="text" id="searchInputreport" placeholder="Filtrar Registro...">
                    </div>

                    <table id="tablaReports">
                        <thead>
                            <tr>
                                <th>Equipo</th>
                                <th>Tipo de Orden</th>
