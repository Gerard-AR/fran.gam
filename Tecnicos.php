            ...
            <div class="details">
                <div class="recentOrders">
                    <div class="cardHeader">
                        <h2>Tecnicos</h2>
                        <!-- Crear tecnico Button -->
                        <div class="button-container">
                        <button class="create-client-btn">Crear Tecnico</button>
                        </div>
                        <!-- Campo de búsqueda -->
                        <input type="text" id="searchInput" placeholder="Buscar tecnico...">
                    ...
                    <table id="tablaTecnicos">
                        ...
                        <tbody>
                            <!-- Aquí se llenarán los datos de los tecnicos -->
                        </tbody>
                    </table>
                </div>
            </div>
          
<!-- Popup para Crear Técnico -->
<div id="createClientPopup" class="popup" style="display: none;">
    <div class="popup-content">
        <span id="closePopup" class="close">&times;</span>
        <h2>Crear Técnico</h2>
        <form id="createClientForm" action="createTechnician.php" method="POST">
