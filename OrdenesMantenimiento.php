        ...
        <ul>
            ...
            <li>
                <a href="Ordenes.php" id="ordersLink" data-page="ordenes">
                    <span class="icon">
                        <svg width="25" height="25" viewBox="0 0 83.73 92.32" fill="currentColor"  ><path d="M21.52,8.63A9.67,9.67,0,0,1,31.13,0H52.6a9.67,9.67,0,0,1,9.61,8.63,55.48,55>
                    </span>
    ...
    <div class="recentOrders">
        <div class="cardHeader">
            ...
            <div class="button-container">
                <button class="create-Orden-btn">Ordén</button>
            </div>
            <input type="text" id="searchInputorden" placeholder="Search orders...">
        </div>

        <table id="tablaOrdenesMantenimiento">
            <thead>
                <tr>
                    <th>Cliente</th>
                    <th>Equipo</th>
            ...
            <tbody>
                <!-- Aquí se llenarán los datos de las órdenes -->
            </tbody>
        </table>
    </div>
</section>
